...
CREATE TABLE media_type
(
    media_type_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    name VARCHAR(120)
);
...
CREATE TABLE playlist
(
    playlist_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    name VARCHAR(120)
);
...
CREATE TABLE bigtable (
    bigtable_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    cola VARCHAR(512),
    colb VARCHAR(512),
    colc VARCHAR(512),
    cold VARCHAR(512),
